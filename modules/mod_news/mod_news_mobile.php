...
<div class="row main-item">
	<div class="col-lg-12">
		...
		<a href="index.php?option=com_content&view=category&id=49&Itemid=1004&lang=<?php echo JRequest::getVar("lang");?>"><img src="<?php echo JURI::base()."timthumb/timthumb.php?src=".JURI::base().$image->image."&h=230&w=600&q=100";?>" /></a> </div>
</div>